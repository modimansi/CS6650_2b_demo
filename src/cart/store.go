...
func (s *Store) GetCart(cartIDInterface interface{}) (*ShoppingCart, error) {
	// Convert interface{} to int for PostgreSQL
...
func (s *Store) GetCartWithItems(cartIDInterface interface{}) (*CartWithItems, error) {
	// Convert interface{} to int for PostgreSQL
	cartID, ok := cartIDInterface.(int)
	if !ok {
		return nil, errors.New("invalid cart ID type for PostgreSQL")
...
func (s *Store) AddOrUpdateItem(cartIDInterface interface{}, productID, quantity int) error {
	// Convert interface{} to int for PostgreSQL
	cartID, ok := cartIDInterface.(int)
	if !ok {
		return errors.New("invalid cart ID type for PostgreSQL")
	}
...
func (s *Store) CheckoutCart(cartIDInterface interface{}) (interface{}, error) {
	// Convert interface{} to int for PostgreSQL
	cartID, ok := cartIDInterface.(int)
	if !ok {
		return 0, errors.New("invalid cart ID type for PostgreSQL")
	}
