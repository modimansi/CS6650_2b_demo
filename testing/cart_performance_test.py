"""
Shopping Cart Performance Test Script
...
Usage:
    python cart_performance_test.py --host http://34.221.149.90:8080
    python cart_performance_test.py --host http://localhost:8080
"""
...
class CartPerformanceTester:
    ...
    def test_add_items(self, cart_id: int, product_id: int, quantity: int) -> Dict[str, Any]:
        """
    ...
    def test_get_cart(self, cart_id: int) -> Dict[str, Any]:
        """
    ...
    def run_performance_test(self) -> bool:
        ...
        """
        self.log("=" * 70)
        self.log("Shopping Cart Performance Test")
        self.log("=" * 70)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Shopping Cart Performance Test - Part 4"
    )
    parser.add_argument(
        '--host',
        type=str,
    ...
    parser.add_argument(
        ...
        help='Output filename (default: mysql_test_results.json)'
    )
